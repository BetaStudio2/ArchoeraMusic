...
import '../widgets/kugou_login_button.dart';
...
/// 未登录引导卡片（按平台展示文案与登录入口）。
class _LoginGuide extends StatelessWidget {
  const _LoginGuide({required this.isKugou, required this.onLogin});
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              isKugou ? l10n.pageLikedKugouLoginDesc : l10n.pageLikedNeteaseLoginDesc,
