                        ...
                        builder: (context, c) {
                          ...
                          final coverBlock = Column(
                            ...
                            children: [
                              ...
                              // 曲名（标题缺失时显示占位，不回退 source 的
                              // 本地绝对路径/在线 URL）
                              Text(
                                hasContent ? (title ?? l10n.playerBarUntitled) : l10n.playerPageNotPlaying,
                          ...
                          final lyricsBlock = hasLyrics
                              ? ClipRect(
                                  child: Consumer(
                                    builder: (context, ref, _) {
                                      final pos = ref.watch(
                                        playbackProvider.select(
                                          (s) => s.position.inMilliseconds,
                                        ),
                                      );
                                      final groups = ref
                                          .watch(currentLyricsProvider)
                                      ...
                                      return LyricsView(
                                        ...
                                        positionMs: pos,
                                        fontSize:
                                            prefs.lyricFontSize * lyricScale,
                                        lineHeight:
                                            prefs.lyricLineHeight * lyricScale,
                                        playedColor: Color(
                                          prefs.lyricPlayedColor,
                                        ),
                                        unplayedColor: Color(
                                          prefs.lyricUnplayedColor,
                                        ),
                                        onSeek: hasSource
                                            ? (ms) => notifier.seek(
                                      ...
                                      SizedBox(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            _CtrlIcon(
                                              tooltip:
                                                  repeatMode == 'list' ? l10n.queueRepeatList : l10n.queueRepeatOne,
                                              icon: repeatMode == 'one'
                                                  ? Icons.repeat_one
                                                  : Icons.repeat,
                                              size: 20,
