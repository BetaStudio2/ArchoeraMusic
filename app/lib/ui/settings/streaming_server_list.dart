...
import '../../core/streaming/streaming_types.dart';
                ...
                SButton(
                  ...
                  onPressed: () async {
                    ...
                    if (s.connected && s.activeServerId == cfg.id) {
                      ...
                      toast(
                        s.connectionError ??
                            l10n.streamingServerConnectFailed,
      ...
      children: [
        ...
        if (_testResult != null)
          Container(
            ...
            padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
            decoration: BoxDecoration(
              color: (_testResult!.ok ? const Color(0xFF34C759) : scheme.error)
                      ...
                      child: Text(
                        _testResult!.ok
                            ? (_testResult!.version != null
                                ? '${l10n.streamingServerTestOk} · v${_testResult!.version}'
